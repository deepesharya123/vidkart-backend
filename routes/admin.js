...
router.post('/register',async(req,res)=>{
    try{
        ...
        const token = jwt.sign({adminEmail,property,adminPassword,adminName},process.env.JWT_ACC_KEY)
        ...
        console.log(e)
        res.send("<center><h1>Something went wrong during your registration.</h1></center>")
    }
})
